...
public class FileSystemStorageServiceTests {
  ...
  @Test
  public void saveByteArrayAndLoad() {
    service.store("Hello World".getBytes(), "foo.txt");
    assertThat(service.load("foo.txt")).exists();
  }
  ...
  public void createThumbnail() throws IOException {
    ...
    service.createThumbnail(filename);

    assertThat(service.load("google_thumbnail.png")).exists();
  }
